...
def convert_to_local_datetime_string(dt_value) -> str:
    """
    Convert datetime or string from a database to the text format YYYY-MM-DD HH:MM:SS,
    while preserving the original time (not converting to UTC). 
    """
    if dt_value is None:
        return None
